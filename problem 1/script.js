var app = {
    ...
    init: function() {
      rxjs.fromEvent(app.title, 'focus').subscribe(app.clearError);
      rxjs.fromEvent(app.message, 'focus').subscribe(app.clearError);

      rxjs.fromEvent(app.title, 'keypress').subscribe(app.detectInput);
      rxjs.fromEvent(app.message, 'keypress').subscribe(app.detectInput);

      rxjs.fromEvent(app.addButton, 'click').subscribe(app.createNote);
  },
  ...
  addNote: function(note) {
      ...
      rxjs.fromEvent(deleteBtn, 'click').subscribe(app.deleteNote);
